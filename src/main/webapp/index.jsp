...
language="java"
import="java.sql.*,java.io.*,java.net.*,org.owasp.encoder.Encode, dbProcs.*,
utils.*"%> <%@ page import="java.util.Locale"%> <%@ include
file="translation.jsp"%> <% ShepherdLogManager.logEvent(request.getRemoteAddr(),
request.getHeader("X-Forwarded-For"), "DEBUG: index.jsp
*************************"); Locale lang = new
Locale(Validate.validateLanguage(request.getSession())); /** * This file is part
of the Security Shepherd Project. * * The Security Shepherd project is free
...
with the Security Shepherd project. If not, see <http://www.gnu.org/licenses/>.
* * @author Mark Denihan */ if (request.getSession() != null) { HttpSession ses
= request.getSession(); Getter get = new Getter(); //Getting CSRF Token from
client Cookie tokenCookie = null; try { tokenCookie =
Validate.getToken(request.getCookies()); } catch(Exception htmlE) {
ShepherdLogManager.logEvent(request.getRemoteAddr(),
request.getHeader("X-Forwarded-For"), "DEBUG(index.jsp): tokenCookie Error:" +
htmlE.toString()); } // validateSession ensures a valid session, and valid role
credentials // Also, if tokenCookie != null, then the page is good to continue
loading if (Validate.validateSession(ses) && tokenCookie != null) { //Log User
Name ShepherdLogManager.logEvent(request.getRemoteAddr(),
request.getHeader("X-Forwarded-For"), "Accessed by: " +
ses.getAttribute("userName").toString(), ses.getAttribute("userName")); //
Getting Session Variables //The org.owasp.encoder.Encode class should be used to
encode any softcoded data. This should be performed everywhere for safety String
csrfToken = Encode.forHtml(tokenCookie.getValue()); String userName =
Encode.forHtml(ses.getAttribute("userName").toString()); String userRole =
Encode.forHtml(ses.getAttribute("userRole").toString()); String userId =
Encode.forJavaScriptBlock(ses.getAttribute("userStamp").toString()); boolean
canSeeScoreboard =
ScoreboardStatus.canSeeScoreboard((String)ses.getAttribute("userRole")); String
csrfJsToken = Encode.forJavaScriptBlock(tokenCookie.getValue()); String
ApplicationRoot = getServletContext().getRealPath(""); boolean showCheatSheet =
CheatSheetStatus.showCheat(userRole); int i = 0; %>
      ...
      <div id="header">
        ...
        <div style="position: absolute; top: 12px; right: 130px">
          <p>
            <strong
              ><%= userName %>&nbsp;&#x7c;&nbsp;<a
                href="logout?csrfToken=<%= csrfToken %>"
                ><fmt:message key="generic.text.logout" /></a
            ></strong>
          </p>
        </div>
      </div>
        ...
        <div id="submitResult">
          <form action="javascript:;" id="resultForm">
            ...
            <table class="resultTable">
              <tr>
                <td class="resultBoxCell">
                  <input type="text" id="moduleResult" class="resultbox"
                  placeholder="<fmt:message
                    key="generic.text.submitResult"
                  />..." autocomplete="OFF" />
                </td>
                <td class="submitResultCell">
                  <div id="submitForm">
                    <input type="submit" value="<fmt:message
                      key="generic.text.submit"
                    />" />
                  </div>
        ...
        >
          ...
          <div id="sidebar">
            <ul>
              ...
              <li>
                <a id="adminList" href="javascript:;"
                  ><div class="menuButton">
                    <fmt:message key="generic.text.admin" /></div
                ></a>
                <ul id="theAdminList" style="display: none">
                  <li>
                    <a id="configurationList" href="javascript:;"
                      ><fmt:message key="generic.text.configuration"
                    /></a>
                    <ul id="theConfigurationList" style="display: none">
                      <li>
                        <a id="aboutShepherdLink" href="javascript:;"
                          ><fmt:message key="generic.text.aboutSecShep"
                        /></a>
                      </li>
                      <li>
                        <a id="cheatSheetLink" href="javascript:;"
                          ><fmt:message
                            key="index.link.admin.cheatSheet.manage"
                        /></a>
                      </li>
                      <li>
                        <a id="configureFeedbackLink" href="javascript:;"
                          ><fmt:message key="index.link.admin.config.feedback"
                        /></a>
                      </li>
                      <li>
                        <a id="registrationLink" href="javascript:;"
                          ><fmt:message key="index.link.admin.config.openClose"
                        /></a>
                      </li>
                      <li>
                        <a id="scoreboardLink" href="javascript:;"
                          ><fmt:message
                            key="index.link.admin.config.scoreboard"
                        /></a>
                      </li>
                      <li>
                        <a id="setCoreDatabaseLink" href="javascript:;"
                          ><fmt:message key="index.link.admin.config.coreDb"
                        /></a>
                      </li>
                    </ul>
                  </li>
                  <li>
                    <a id="moduleManagementList" href="javascript:;"
                      ><fmt:message key="index.link.admin.moduleManage"
                    /></a>
                    <ul id="theModuleManagementList" style="display: none">
                      <li>
                        <a id="levelLayoutLink" href="javascript:;"
                          ><fmt:message key="index.link.admin.config.change"
                        /></a>
                      </li>
                      <li>
                        <a id="moduleBlockLink" href="javascript:;"
                          ><fmt:message
                            key="index.link.admin.moduleManage.block"
                        /></a>
                      </li>
                      <li>
                        <a id="setModuleStatusLink" href="javascript:;"
                          ><fmt:message
                            key="index.link.admin.moduleManage.openClose"
                        /></a>
                      </li>
                      <li>
                        <a id="openCloseByCategory" href="javascript:;"
                          ><fmt:message
                            key="index.link.admin.moduleManage.openCloseCategory"
                        /></a>
                      </li>
                      <li>
                        <a id="feedbackLink" href="javascript:;"
                          ><fmt:message
                            key="index.link.admin.moduleManage.feedback"
                        /></a>
                      </li>
                      <li>
                        <a id="progressLink" href="javascript:;"
                          ><fmt:message
                            key="index.link.admin.moduleManage.progress"
                        /></a>
                      </li>
                    </ul>
                  </li>
                  <li>
                    <a id="userManagementList" href="javascript:;"
                      ><fmt:message key="index.link.admin.userMange"
                    /></a>
                    <ul id="theUserManagementList" style="display: none">
                      <li>
                        <a id="addPlayersLink" href="javascript:;"
                          ><fmt:message
                            key="index.link.admin.userMange.addPlayer"
                        /></a>
                      </li>
                      <li>
                        <a id="deletePlayersLink" href="javascript:;"
                          ><fmt:message
                            key="index.link.admin.userMange.deletePlayer"
                        /></a>
                      </li>
                      <li>
                        <a id="updatePlayerScoreLink" href="javascript:;"
                          ><fmt:message
                            key="index.link.admin.userMange.addPoints"
                        /></a>
                      </li>
                      <li>
                        <a id="assignPlayersLink" href="javascript:;"
                          ><fmt:message
                            key="index.link.admin.userMange.assignPlayer"
                        /></a>
                      </li>
                      <li>
                        <a id="createNewClassLink" href="javascript:;"
                          ><fmt:message
                            key="index.link.admin.userMange.createClass"
                        /></a>
                      </li>
                      <li>
                        <a id="createNewAdminLink" href="javascript:;"
                          ><fmt:message
                            key="index.link.admin.userMange.createAdmin"
                        /></a>
                      </li>
                      <li>
                        <a id="changePlayerPasswordLink" href="javascript:;"
                          ><fmt:message
                            key="index.link.admin.userMange.resetPass"
                        /></a>
                      </li>
                      <li>
                        <a
                          id="setDefaultClassForRegistrationLink"
                          href="javascript:;"
                          ><fmt:message
                            key="index.link.admin.userMange.setDefaultPlayerClass"
                        /></a>
                      </li>
                      <li>
                        <a id="suspendPlayerLink" href="javascript:;"
                          ><fmt:message
                            key="index.link.admin.userMange.suspendPlayer"
                        /></a>
                      </li>
                      <li>
                        <a id="unSuspendPlayerLink" href="javascript:;"
                          ><fmt:message
                            key="index.link.admin.userMange.unsuspendPlayer"
                        /></a>
                      </li>
                      <li>
                        <a id="upgradePlayersLink" href="javascript:;"
                          ><fmt:message
                            key="index.link.admin.userMange.upgradeToAdmin"
                        /></a>
                      </li>
                      <li>
                        <a id="downgradeAdminLink" href="javascript:;"
                          ><fmt:message
                            key="index.link.admin.userMange.downgradeToPlayer"
                        /></a>
                      </li>
                    </ul>
                  </li>
              ...
              <div id="scoreboardButton">
                <a id="showScoreboard" href="scoreboard.jsp" target="bar"
                  ><div class="menuButton">
                    <fmt:message key="generic.text.scoreboard" /></div
                ></a>
              </div>
              <% } %> <% if(showCheatSheet) { %>
              <div id="cheatSheetButton" style="display: none">
                <a id="showSolution" href="javascript:;"
                  ><div class="menuButton">
                    <fmt:message key="generic.text.cheat" /></div
                ></a>
              </div>
              <% } if (CountdownHandler.isRunning() ||
              (userRole.compareTo("admin") == 0) ) { %>
              <div id="levelListDiv">
                <div id="sideMenuWrapper">
                  <% if(ModulePlan.isOpenFloor()) { %>
                  <li>
                    <a id="lessonList" href="javascript:;"
                      ><div class="menuButton">
                        <fmt:message key="generic.text.lessons" /></div
                    ></a>
                    <ul id="theLessonList" style="display: none">
                      <%= Getter.getLessons(ApplicationRoot,
                      (String)ses.getAttribute("userStamp"), lang) %>
                    </ul>
                  </li>
                  <li>
                    <a id="challengeList" href="javascript:;"
                      ><div class="menuButton">
                        <fmt:message key="generic.text.challenges" /></div
                    ></a>
                    <ul id="theChallengeList" style="display: none">
                      <%= Getter.getChallenges(ApplicationRoot,
                      (String)ses.getAttribute("userStamp"), lang) %>
                    </ul>
                  </li>
                  <% } else { if(ModulePlan.isIncrementalFloor()){ %> <%=
                  Getter.getIncrementalModulesWithoutScript(ApplicationRoot,
                  (String)ses.getAttribute("userStamp"),
                  ses.getAttribute("lang").toString() ,csrfToken) %> <% } else
                  {%>
                  <li>
                    <%= Getter.getTournamentModules(ApplicationRoot,
                    (String)ses.getAttribute("userStamp"), lang) %>
                  </li>
              ...
              <div>
                ...
                placeholder="<fmt:message
                  key="generic.text.searchModules"
                />...">
              </div>
              ...
              <script>
                function makeSearchList() {
                  ...
                  console.log(
                    availableModules.length + " modules added to search list"
                  );
                ...
                $("#searchModules").on(
                  ...
                  function (event, ui) {
                    ...
                    $(".lesson").each(function (index) {
                      console.log($(this));
                      if ($(this).html().indexOf(toOpen) > -1) {
                        //If the Level description exists in the lesson entry, then we have the right one
                ...
                $("#searchModules").on(
                  ...
                  function (event, ui) {
                    ...
                    $("#theSidebarWrapper")
                      .removeClass("sidebarWrapper")
                      .addClass("sidebarWrapperAlwaysOpen");
                  }
                );
                ...
                $("#searchModules").on(
                  ...
                  function (event, ui) {
                    ...
                    $("#theSidebarWrapper")
                      .removeClass("sidebarWrapperAlwaysOpen")
                      .addClass("sidebarWrapper");
                  }
                );
              </script>
              <div id="startTimer">
    ...
    <script>
      $("#contentDiv").load("getStarted.jsp", function (response, status, xhr) {
        if (status == "error") {
          ...
          $("#contentDiv").html(
            "<p>" + msg + xhr.status + " " + xhr.statusText + "</p>"
          );
        }
      });
    </script>

    <% //Hide UI Scripts from Users (Blocked at session level anyway, just stops
    spiders finding the links) if (userRole.compareTo("admin") == 0){ %>
...
<% } else { response.sendRedirect("login.jsp"); } } else {
